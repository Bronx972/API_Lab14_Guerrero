    ...
    public class CustomersController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Customer>>> GetCustomers()
        {
          if (_context.Customers == null)
          {
            ...
            return await _context.Customers.Where(x => x.Active == 1 ).ToListAsync();
        }
        ...
        [HttpPost]
        public  List<Customer> Listar_Clientes(string FirstName, string LastName )
        {
            if (FirstName != null)
            {
                result = _context.Customers.Where(x => x.FirstName == FirstName);
            }
            if (LastName != null)
            {
                result = _context.Customers.Where(x => x.LastName == LastName);
            }
